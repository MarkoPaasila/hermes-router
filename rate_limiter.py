...
class AdaptiveRateLimiter:
    ...
    def headroom(self, provider_name: str, key: str, model: str) -> float:
        """Read-only raw fractional headroom. Does not create bucket groups."""
        with self._lock:
        ...
        with self._lock:
            ...
            for gk, g in self._groups.items():
                ...
                out.append({
                    ...
                    "configured": is_cfg,
                    "headroom": headroom,
                    "comparable_headroom": comparable,
                    "binding": binding,
                    "buckets": buckets,
    ...
    def start_flush_thread(self) -> None:
        ...
        t.start()
        log.info(f"[rate] flush thread started (interval={RATE_STATE_FLUSH_S}s)")
