...
The [VS Code extension](/vscode-extension/) talks to the proxy over HTTP, so it works against
...
**Next:** [Providers](/providers/) — add free API keys so the proxy has providers to route across.
